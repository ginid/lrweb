<%-- 
    Document   : dl_request_confirmed
    Created on : 6 Dec, 2012, 9:06:53 PM
    Author     : rishabh
--%>
    ...
    <body>
        ...
        <div id="content" style="width:90%">
            <div class="post1"  style="background: none">
                <h2 class="title">Duplicate License Form Submitted</h2>
                <div class="entry">
                    <%
                    int dlno=CommonTasks.getNextDLApplicationNo();
                    try{
                        java.util.Date today=new java.util.Date();
                        Connection con=DatabaseConnection.getConnection();
                        PreparedStatement pstmt=con.prepareStatement("insert into DuplicateLicenseJSP values(?,?,?,?,?,?,?)");
                        pstmt.setInt(1,dlno );                                                    
                        String str=String.format("%1$tm-%1$td-%1$ty", today);
                        pstmt.setString(2,str);
                        pstmt.setString(3, dlbean.getName());
                        pstmt.setString(4,dlbean.getFathername());
                        pstmt.setString(5,dlbean.getPermanentAddress());
                        pstmt.setString(6,dlbean.getLosingDate());
                        pstmt.setString(7,dlbean.getLosingCircumstances());                        
                        pstmt.executeUpdate();
                        %>
                        <p>Your Form has been Successfully Received.</p>
                        <p>Kindly note down the Application No.<%= dlno %></p>
